# Respuesta generada — `.env.example` y `SETUP.md` (readiness)

## .env.example

```
# Supabase (URL pública para cliente)
NEXT_PUBLIC_SUPABASE_URL=
# Supabase anon/public key (solo para cliente)
NEXT_PUBLIC_SUPABASE_ANON_KEY=
# Supabase service role key (solo para server, mantener secreto)
SUPABASE_SERVICE_ROLE_KEY=
# URL de la base de datos (si aplica para migraciones)
DATABASE_URL=
# NODE_ENV=development|production
NODE_ENV=development
# Puerto de desarrollo (opcional)
PORT=3000
# Llaves de servicios externos de la extensión (si aplica)
# EJEMPLO: API_KEY_THIRD_SERVICE=
```

## SETUP.md (resumen de pasos previos)
...
---
Generado automáticamente como guía de readiness.
